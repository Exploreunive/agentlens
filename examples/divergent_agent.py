...
def emit_run(*, recalled_memory: str, tool_condition: str, final_answer: str) -> str:
    ...
    with client.span(run_id=run_id, name='evaluate_weather_decision', payload={'mode': 'divergent_demo'}) as root_span:
        ...
        client.record_tool_call(
            ...
            result={'condition': tool_condition, 'temperature_c': 18},
